...
function updateClockDisplay() {
    ...
    if (GAME_SPEED == 1) {icon.attr("src", "images/ui_speed_1.png")}
    if (GAME_SPEED == 5) {icon.attr("src", "images/ui_speed_2.png")}
    if (GAME_SPEED == 10) {icon.attr("src", "images/ui_speed_3.png")}
